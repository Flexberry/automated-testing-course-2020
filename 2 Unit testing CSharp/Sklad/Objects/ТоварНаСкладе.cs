...
namespace IIS.Sklad
{
    ...
    [View("ТоварНаСкладеD", new string[] {
            "Количество",
            "Склад",
            "Товар"})]
    public class ТоварНаСкладе : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Sklad.Склад fСклад;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Sklad.Склад.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Склад"})]
        public virtual IIS.Sklad.Склад Склад
        {
            get
            {
                ...
                IIS.Sklad.Склад result = this.fСклад;
        ...
        public class Views
        {
            ...
            /// "ТоварНаСкладеD" view.
            /// </summary>
            public static ICSSoft.STORMNET.View ТоварНаСкладеD
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТоварНаСкладеD", typeof(IIS.Sklad.ТоварНаСкладе));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТоварНаСкладе : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Sklad.DetailArrayOfТоварНаСкладе members)

        // *** End programmer edit section *** (IIS.Sklad.DetailArrayOfТоварНаСкладе members)
        ...
        /// </summary>
        public DetailArrayOfТоварНаСкладе(IIS.Sklad.Склад fСклад) : 
                base(typeof(ТоварНаСкладе), ((ICSSoft.STORMNET.DataObject)(fСклад)))
        {
        }
        
        public IIS.Sklad.ТоварНаСкладе this[int index]
        {
            get
            {
                return ((IIS.Sklad.ТоварНаСкладе)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Sklad.ТоварНаСкладе dataobject)
        {
